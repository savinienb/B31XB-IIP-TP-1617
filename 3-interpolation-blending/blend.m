function blend_im = blend(im,second_im)
...
% 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% % this triple loop copy the second half of the second resized image into the output
% % image
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% 
...
for index_blendhorizontal = (round(first_size(2)/2) : round(first_size(2)))    
    for index_blendvertical = 1:first_size(1)
        for index_matrix=1:first_size(3);          
           blend_im(index_blendvertical,index_blendhorizontal,index_matrix)=second_resizedimage(index_blendvertical,index_secondhorizontal,index_matrix);
        end
    end
